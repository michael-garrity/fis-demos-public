    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://flatiron-school-0z.sentry.io/issues/?project=4510421244772352">Issues Page</a>.
        ...
        <button
          ...
          onClick={async () => {
            await Sentry.startSpan({
              name: 'Test Frontend/Backend Span',
              op: 'test'
            }, async () => {
            ...
            throw new SentryExampleFrontendError("This error is raised on the frontend of the test page.");
          }}
