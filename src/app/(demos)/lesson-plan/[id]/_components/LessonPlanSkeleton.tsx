...
/**
 * Renders a skeleton loading state for the primary course metadata card.
 * This mocks the structure of the Course Title, Description, and the three metadata Chips
